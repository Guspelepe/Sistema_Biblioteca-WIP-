...
const LIVROS_INICIAIS = [
    ...
    { titulo: "A Menina que Roubava Livros - Markus Zusak", autor: "Markus Zusak", ano: 2005, editora: "Intrínseca", genero: "romance, ficçao", classificacao: "12+", sinopse: "Narrada pela Morte, a história acompanha Liesel Meminger, uma garota que enfrenta os horrores da Alemanha nazista encontrando conforto nos livros." },
    ...
    { titulo: "A Náusea - Jean-Paul Sartre", autor: "Jean-Paul Sartre", ano: 1938, editora: "Nova Fronteira", genero: "romance, ficçao filosofica", classificacao: "16+", sinopse: "A Náusea acompanha Antoine Roquentin, um historiador que, ao viver em uma pequena cidade francesa, é tomado por uma profunda crise existencial e passa a registrar em seu diário o horror e o absurdo de perceber a existência gratuita e sem sentido do mundo ao seu redor." },
    { titulo: "A Peste - Albert Camus", autor: "Albert Camus", ano: 1947, editora: "Record", genero: "romance, ficçao filosofica", classificacao: "18+", sinopse: "A história retrata o isolamento e a resistência de uma comunidade na Argélia assolada por uma epidemia fatal." },
    ...
    { titulo: "A Seleção - Kiera Cass", autor: "Kiera Cass", ano: 2012, editora: "Seguinte", genero: "ficçao juvenil, romance.", classificacao: "12+", sinopse: "Trinta e cinco garotas são selecionadas para competir pelo coração do príncipe Maxon e pelo trono de Illéa." },
    { titulo: "A Sombra do Vento - Carlos Ruiz Zafón", autor: "Carlos Ruiz Zafón", ano: 2001, editora: "Suma", genero: "romance, suspense, misterio.", classificacao: "16+", sinopse: "Em Barcelona (1945), o jovem Daniel Sempere descobre um livro misterioso e embarca em uma perigosa jornada para desvendar a identidade do autor Julián Carax, cujas obras estão sendo sistematicamente destruídas." },
    { titulo: "Admirável Mundo Novo - Aldous Huxley", autor: "Aldous Huxley", ano: 1932, editora: "Globo", genero: "romance, ficçao cientifica, ficçao distopica", classificacao: "14+", sinopse: "O Estado Mundial controla a vida dos cidadãos desde a concepção em laboratórios, eliminando a família, o amor e a individualidade em prol da estabilidade e do consumo." },
    { titulo: "Água Viva - Clarice Lispector", autor: "Clarice Lispector", ano: 1973, editora: "Rocco", genero: "romance lirico, poema em prosa", classificacao: "16+", sinopse: "uma pintora sem nome abandona a narrativa tradicional para mergulhar em um fluxo de consciência poético, onde reflete intensamente sobre o tempo, a existência e a tentativa de capturar a essência crua do momento presente." },
    ...
    { titulo: "Anne de Green Gables - Lucy Maud Montgomery", autor: "Lucy Maud Montgomery", ano: 1908, editora: "Principis", genero: "romance, ficçao", classificacao: "11+", sinopse: "A órfã Anne Shirley é adotada por engano por dois irmãos idosos que esperavam um menino para ajudar na fazenda." },
    ...
    { titulo: "Brasil: Uma Biografia - Lilia M. Schwarcz & Heloisa M. Starling", autor: "Lilia M. Schwarcz", ano: 2015, editora: "Companhia das Letras", genero: "ensaio historico", classificacao: "16+", sinopse: "Em 'Brasil: Uma Biografia', Lilia M. Schwarcz e Heloisa M. Starling oferecem uma releitura da história nacional ao longo de mais de quinhentos anos." },
    ...
    { titulo: "Casa-Grande & Senzala - Gilberto Freyre", autor: "Gilberto Freyre", ano: 1933, editora: "Global", genero: "ensaio sociologico, antropologia", classificacao: "16+", sinopse: "A obra fundante de Gilberto Freyre, publicada em 1933, analisa a formação da sociedade brasileira através da miscigenação e da interação entre portugueses, indígenas e negros, tendo a Casa-Grande (o poder patriarcal) e a Senzala (a exploração escravista) como núcleos da economia açucareira e das relações socioculturais coloniais." },
    ...
    { titulo: "Cidades de Papel - John Green", autor: "John Green", ano: 2008, editora: "Intrínseca", genero: "romance, ficcao juvenil", classificacao: "14+", sinopse: "Em 'Cidades de Papel', de John Green, Quentin Jacobsen embarca em uma noite de aventuras com sua vizinha Margo." },
    { titulo: "Clube da Luta - Chuck Palahniuk", autor: "Chuck Palahniuk", ano: 1996, editora: "LeYa", genero: "romance, ficcao", classificacao: "18+", sinopse: "Um jovem trabalhador com insônia, sufocado pelo consumismo, funda um clube de luta clandestino com um vendedor de sabonete carismático para escapar do vazio da vida moderna, desencadeando uma espiral de caos e anarquia." },
    ...
    { titulo: "Divergente - Veronica Roth", autor: "Veronica Roth", ano: 2011, editora: "Rocco", genero: "romance, ficcao juvenil", classificacao: "14+", sinopse: "Em uma Chicago distópica, a sociedade é dividida em cinco facções. Beatrice Prior descobre ser uma 'Divergente' – alguém que não se encaixa em nenhum grupo específico – e precisa esconder seu segredo enquanto enfrenta uma iniciação mortal e descobre uma conspiração para destruir o sistema." },
    ...
    { titulo: "Doutor Jivago - Boris Pasternak", autor: "Boris Pasternak", ano: 1957, editora: "Companhia das Letras", genero: "romance historico", classificacao: "12+", sinopse: "A obra-prima de Boris Pasternak narra a trajetória do médico e poeta Iúri Jivago enquanto sua vida pessoal, dividida entre sua esposa e a apaixonante Lara, é tragicamente consumida pelo caos, pelas guerras e pelas profundas transformações sociais da Revolução Russa." },
    ...
    { titulo: "Ensaio sobre a Cegueira - José Saramago", autor: "José Saramago", ano: 1995, editora: "Companhia das Letras", genero: "romance distopico, ficcao", classificacao: "16+", sinopse: "Obra de José Saramago narra o colapso de uma sociedade atingida por uma misteriosa epidemia de 'cegueira branca'." },
    { titulo: "Extraordinário - R.J. Palacio", autor: "R.J. Palacio", ano: 2012, editora: "Intrínseca", genero: "ficcao juvenil, romance", classificacao: "Livre", sinopse: "O livro Extraordinário acompanha August Pullman, um menino de 10 anos com uma severa deformidade facial." },
    { titulo: "Fahrenheit 451 - Ray Bradbury", autor: "Ray Bradbury", ano: 1953, editora: "Globo", genero: "romance, ficcao", classificacao: "12+", sinopse: "Nesta distopia de Ray Bradbury, Guy Montag é um 'bombeiro' cuja profissão não é apagar incêndios, mas sim queimar livros." },
    { titulo: "Fortaleza Digital - Dan Brown", autor: "Dan Brown", ano: 1998, editora: "Arqueiro", genero: "suspense tecnologico", classificacao: "14+", sinopse: "O livro Fortaleza Digital acompanha Susan Fletcher, a principal criptógrafa da NSA, em uma corrida contra o tempo para decifrar um código indestrutível criado por um ex-funcionário, que ameaça expor os segredos de vigilância do governo americano para o mundo todo." },
    ...
    { titulo: "Grande Sertão: Veredas - João Guimarães Rosa", autor: "João Guimarães Rosa", ano: 1956, editora: "Nova Fronteira", genero: "ficcao regionalista", classificacao: "18+", sinopse: "Em 'Grande Sertão: Veredas', de João Guimarães Rosa, o ex-jagunço Riobaldo rememora sua vida ao relatar suas andanças pelo sertão, sua guerra contra bandos rivais, o suposto pacto com o diabo e seu profundo e reprimido amor por Diadorim" },
    { titulo: "Guerra e Paz - Liev Tolstói", autor: "Liev Tolstói", ano: 1869, editora: "Companhia das Letras", genero: "romance historico", classificacao: "14+", sinopse: "A obra Guerra e Paz, de Liev Tolstói, narra a trajetória de cinco famílias aristocráticas russas enquanto a sociedade vive a brutal invasão e os impactos das guerras napoleônicas." },
    { titulo: "Hamlet - William Shakespeare", autor: "William Shakespeare", ano: 1603, editora: "L&PM", genero: "tragedia", classificacao: "14+", sinopse: "O príncipe da Dinamarca simula loucura para investigar a morte do pai e vingar-se do tio, que usurpou o trono e casou-se com sua mãe, em uma jornada marcada por tragédia, indecisão e dilemas morais" },
    ...
    { titulo: "Inferno - Dan Brown", autor: "Dan Brown", ano: 2013, editora: "Arqueiro", genero: "suspense, misterio", classificacao: "14+", sinopse: "O simbologista Robert Langdon acorda em Florença com amnésia e precisa decifrar enigmas baseados na obra de Dante Alighieri para impedir a liberação de um vírus letal" },
    ...
    { titulo: "It: A Coisa - Stephen King", autor: "Stephen King", ano: 1986, editora: "Suma", genero: "terror", classificacao: "16+", sinopse: "Em uma pacata cidade, sete amigos enfrentam uma entidade maligna que assume a forma de seus maiores medos, retornando décadas depois como adultos para destruir a criatura de vez" },
    ...
    { titulo: "Jogos Vorazes - Suzanne Collins", autor: "Suzanne Collins", ano: 2008, editora: "Rocco", genero: "ficcao cientifica, distopia, acao", classificacao: "14+", sinopse: "Em um futuro pós-apocalíptico, jovens de 12 a 18 anos são sorteados para lutar até a morte em um reality show cruel organizado pela tirânica Capital" },
    { titulo: "Lira dos Vinte Anos - Álvares de Azevedo", autor: "Álvares de Azevedo", ano: 1853, editora: "Ática", genero: "literario lirico", classificacao: "12+", sinopse: "A obra Lira dos Vinte Anos de Álvares de Azevedo é uma coletânea poética da segunda geração romântica que oscila entre o amor platônico, a melancolia ultrarrromântica e o tédio existencial" },
    ...
    { titulo: "Lucíola - José de Alencar", autor: "José de Alencar", ano: 1862, editora: "Ática", genero: "romance, ficcao literaria", classificacao: "12+", sinopse: "A obra narra a história de Paulo, um jovem ingênuo que chega ao Rio de Janeiro e se apaixona por Lúcia, uma cortesã de luxo" },
    { titulo: "Macunaíma - Mário de Andrade", autor: "Mário de Andrade", ano: 1928, editora: "Companhia das Letras", genero: "romance, ficcao, humor", classificacao: "12+", sinopse: "" },
    ...
    { titulo: "Memorial de Aires - Machado de Assis", autor: "Machado de Assis", ano: 1908, editora: "Companhia das Letras", genero: "romance", classificacao: "12+", sinopse: "Publicado em 1908, 'Memorial de Aires' é o último romance de Machado de Assis. Escrito em formato de diário, narra os anos de 1888 e 1889 na visão do Conselheiro Aires, um diplomata aposentado" },
    { titulo: "Memórias Póstumas de Brás Cubas - Machado de Assis", autor: "Machado de Assis", ano: 1881, editora: "Companhia das Letras", genero: "romance, ficcao literaria", classificacao: "14+", sinopse: "o romance acompanha a trajetória do aristocrata Brás Cubas que, após morrer, decide escrever suas memórias da sepultura, revisitando com ironia e pessimismo suas ambições frustradas" },
    { titulo: "Moby Dick - Herman Melville", autor: "Herman Melville", ano: 1851, editora: "Cosac Naify", genero: "romance, aventura maritima", classificacao: "12+", sinopse: "O marinheiro Ismael embarca no navio baleeiro Pequod e narra a jornada obsessiva do capitão Ahab em busca de vingança contra Moby Dick, a gigantesca e temida baleia branca que lhe arrancou uma perna." },
    { titulo: "Morte e Vida Severina - João Cabral de Melo Neto", autor: "João Cabral de Melo Neto", ano: 1955, editora: "Nova Fronteira", genero: "poesia dramatica", classificacao: "12+", sinopse: "A obra-prima de João Cabral de Melo Neto narra a trajetória de Severino, um retirante sertanejo que foge da seca e da miséria extrema no agreste pernambucano" },
    { titulo: "Noite na Taverna - Álvares de Azevedo", autor: "Álvares de Azevedo", ano: 1855, editora: "Ática", genero: "prosa de ficcao, literatura gotica", classificacao: "16+", sinopse: "O livro Noite na Taverna de Álvares de Azevedo apresenta cinco amigos boêmios que, durante uma noite chuvosa em uma taverna, compartilham histórias assustadoras e macabras de seus passados repletos de amores impossíveis" },
    ...
    { titulo: "O Apanhador no Campo de Centeio - J.D. Salinger", autor: "J.D. Salinger", ano: 1951, editora: "Editora do Autor", genero: "romance, ficcao juvenil", classificacao: "14+", sinopse: "Holden Caulfield, um adolescente revoltado e em crise com o mundo adulto, vaga por Nova York durante três dias após ser expulso do internato, lidando com a perda da inocência e a hipocrisia da sociedade" },
    { titulo: "O Auto da Compadecida - Ariano Suassuna", autor: "Ariano Suassuna", ano: 1955, editora: "Agir", genero: "dramatico", classificacao: "Livre", sinopse: "A história acompanha as aventuras de João Grilo e Chicó, dois amigos nordestinos que sobrevivem no sertão à base de muita astúcia e mentira." },
    ...
    { titulo: "O Estrangeiro - Albert Camus", autor: "Albert Camus", ano: 1942, editora: "Record", genero: "ficcao filosofica, romance", classificacao: "14+", sinopse: "A obra narra a história de Meursault, um homem apático e indiferente às convenções sociais." },
    { titulo: "O Grande Gatsby - F. Scott Fitzgerald", autor: "F. Scott Fitzgerald", ano: 1925, editora: "Penguin", genero: "romance, tragedia", classificacao: "14+", sinopse: "um jovem misterioso e milionário chamado Jay Gatsby faz de tudo para reconquistar Daisy Buchanan, seu grande amor do passado, enquanto a narrativa expõe o vazio e a decadência da alta sociedade americana na década de 1920" },
    ...
    { titulo: "O Hobbit - J.R.R. Tolkien", autor: "J.R.R. Tolkien", ano: 1937, editora: "HarperCollins", genero: "romance, literatura fantastica, literatura juvenil", classificacao: "10+", sinopse: "O hobbit Bilbo Bolseiro deixa sua vida pacata para acompanhar o mago Gandalf e treze anões em uma perigosa jornada pela Terra-média, com o objetivo de recuperar um tesouro ancestral roubado pelo temido dragão Smaug" },
    { titulo: "O Homem que Calculava - Malba Tahan", autor: "Malba Tahan", ano: 1938, editora: "Record", genero: "ficcao, romance infanto-juvenil", classificacao: "14+", sinopse: "O Homem que Calculava narra as aventuras de Beremiz Samir, um genial calculista persa que viaja pela antiga Arábia usando seu raciocínio lógico e talento matemático para solucionar problemas cotidianos aparentemente impossíveis, encantando califas e sábios pelo caminho." },
    ...
    { titulo: "O Morro dos Ventos Uivantes - Emily Brontë", autor: "Emily Brontë", ano: 1847, editora: "Penguin", genero: "romance de tragedia, drama", classificacao: "14+", sinopse: "Uma trágica e obsessiva história de amor e vingança entre Heathcliff e Catherine Earnshaw, cujo romance proibido e desencontros moldam um ciclo de destruição que atravessa gerações na sombria paisagem rural da Inglaterra" },
    { titulo: "O Nome da Rosa - Umberto Eco", autor: "Umberto Eco", ano: 1980, editora: "Record", genero: "romance, misterio", classificacao: "16+", sinopse: "A trama segue o frei Guilherme de Baskerville e seu noviço Adso de Melk enquanto investigam uma série de assassinatos misteriosos em uma abadia italiana, cujos crimes estão ligados à sua vasta e secreta biblioteca" },
    ...
    { titulo: "O Pequeno Príncipe - Antoine de Saint-Exupéry", autor: "Antoine de Saint-Exupéry", ano: 1943, editora: "Agir", genero: "literatura infantil, fabula, fantasia", classificacao: "Livre", sinopse: "Um piloto cai com seu avião no deserto do Saara e encontra um menino misterioso de cabelos dourados, originário de um asteroide minúsculo" },
    { titulo: "O Perfume - Patrick Süskind", autor: "Patrick Süskind", ano: 1985, editora: "Record", genero: "romance, ficcao policial, misterio", classificacao: "18+", sinopse: "Na França do século XVIII, Jean-Baptiste Grenouille, um jovem com um olfato sobre-humano e sem cheiro próprio, torna-se um perfumista obcecado." },
    { titulo: "O Povo Brasileiro - Darcy Ribeiro", autor: "Darcy Ribeiro", ano: 1995, editora: "Companhia das Letras", genero: "ensaio sociologico", classificacao: "12+", sinopse: "O livro 'O Povo Brasileiro', de Darcy Ribeiro, investiga a formação da identidade nacional através da fusão violenta e miscigenada de três matrizes: indígenas, africanos e europeus, resultando na criação de um povo novo com cultura e destino singulares." },
    { titulo: "O Processo - Franz Kafka", autor: "Franz Kafka", ano: 1925, editora: "Companhia das Letras", genero: "romance, humor, ficcao distopica", classificacao: "16+", sinopse: "um bancário que é subitamente preso e submetido a um processo judicial interminável e labiríntico" },
    ...
    { titulo: "O Sol é para Todos - Harper Lee", autor: "Harper Lee", ano: 1960, editora: "José Olympio", genero: "romance, ficcao", classificacao: "14+", sinopse: "Em O Sol é para Todos de Harper Lee, a história acompanha um advogado que enfrenta o racismo extremo no Alabama dos anos 1930 ao defender um homem negro injustamente acusado de estupro, tudo sob a perspectiva sensível e questionadora de sua filha pequena" },
    { titulo: "O Símbolo Perdido - Dan Brown", autor: "Dan Brown", ano: 2009, editora: "Arqueiro", genero: "suspense, misterio", classificacao: "14", sinopse: "O simbologista Robert Langdon é atraído a uma armadilha no Capitólio dos EUA e precisa decifrar códigos maçônicos por Washington, D.C., para salvar a vida de seu mentor sequestrado e desvendar um antigo segredo" },
    { titulo: "O Tempo e o Vento - Érico Veríssimo", autor: "Érico Veríssimo", ano: 1949, editora: "Companhia das Letras", genero: "romance historico", classificacao: "14+", sinopse: "A obra-prima O Tempo e o Vento de Érico Veríssimo narra a saga da família Terra-Cambará ao longo de duzentos anos (1745-1945), entrelaçando a formação e a transformação histórica, social e cultural do Rio Grande do Sul e do Brasil" },
    { titulo: "Orgulho e Preconceito - Jane Austen", autor: "Jane Austen", ano: 1813, editora: "Penguin", genero: "ficcao, romance de amor", classificacao: "12+", sinopse: "A obra acompanha Elizabeth Bennet na Inglaterra do século XIX, cujo destino muda com a chegada do rico Sr. Darcy" },
    { titulo: "Os Miseráveis - Victor Hugo", autor: "Victor Hugo", ano: 1862, editora: "Martin Claret", genero: "romance, tragedia", classificacao: "12+", sinopse: "A saga acompanha o ex-presidiário Jean Valjean que, após ser condenado por roubar um pão, busca redenção e uma nova vida acolhendo a órfã Cosette, enquanto é implacavelmente perseguido pelo inspetor Javert na França do século XIX." },
    { titulo: "Os Sertões - Euclides da Cunha", autor: "Euclides da Cunha", ano: 1902, editora: "Companhia das Letras", genero: "relato historico, ensaio sociologico", classificacao: "12+", sinopse: "Os Sertões narra a trágica Guerra de Canudos (1896-1897), unindo literatura e reportagem para expor o massacre de sertanejos pelo Exército" },
    { titulo: "Poemas - Carlos Drummond de Andrade", autor: "Carlos Drummond de Andrade", ano: 2012, editora: "Companhia das Letras", genero: "lirico", classificacao: "Livre", sinopse: "Os poemas de Carlos Drummond de Andrade exploram a angústia existencial, o cotidiano, a solidão na cidade grande e a reflexão social, marcando a poesia brasileira com uma visão irônica, melancólica e profundamente humana do indivíduo deslocado perante o mundo" },
    ...
    { titulo: "Quincas Borba - Machado de Assis", autor: "Machado de Assis", ano: 1891, editora: "Companhia das Letras", genero: "romance, ficcao", classificacao: "14+", sinopse: "O ingênuo professor Rubião herda a imensa fortuna do filósofo criador do 'Humanitismo', com a condição de cuidar de seu cachorro." },
    { titulo: "Raízes do Brasil - Sérgio Buarque de Holanda", autor: "Sérgio Buarque de Holanda", ano: 1936, editora: "Companhia das Letras", genero: "ensaio historico, sociologia", classificacao: "Livre", sinopse: "A obra fundadora da sociologia Raízes do Brasil investiga a formação da sociedade brasileira a partir do legado português, analisando como o personalismo e o famoso conceito do 'homem cordial'" },
    { titulo: "Ratos e Homens - John Steinbeck", autor: "John Steinbeck", ano: 1937, editora: "Record", genero: "ficcao historica, novela", classificacao: "14+", sinopse: "A narrativa acompanha George e Lennie, dois trabalhadores rurais migrantes na Califórnia durante a Grande Depressão, que lutam para sobreviver enquanto tentam realizar o sonho de possuir seu próprio pedaço de terra." },
    { titulo: "Romeu e Julieta - William Shakespeare", autor: "William Shakespeare", ano: 1597, editora: "L&PM", genero: "dramatico", classificacao: "12+", sinopse: "A clássica tragédia de William Shakespeare, ambientada em Verona, narra a paixão proibida entre Romeu Montéquio e Julieta Capuleto. Pertencentes a famílias rivais, eles enfrentam o ódio geracional." },
    ...
    { titulo: "Sidarta - Hermann Hesse", autor: "Hermann Hesse", ano: 1922, editora: "Record", genero: "romance, ficcao", classificacao: "16+", sinopse: "A obra-prima de Hermann Hesse narra a jornada espiritual de um jovem indiano que abandona uma vida de privilégios para buscar a verdadeira iluminação através de experiências que vão do ascetismo rigoroso aos prazeres mundanos" },
    { titulo: "Ulisses - James Joyce", autor: "James Joyce", ano: 1922, editora: "Companhia das Letras", genero: "romance, ficcao", classificacao: "15+", sinopse: "O livro Ulisses narra as andanças, os pensamentos e o cotidiano do publicitário Leopold Bloom e do jovem Stephen Dedalus pelas ruas de Dublin, durante um único dia: 16 de junho de 1904" },
    { titulo: "Vidas Secas - Graciliano Ramos", autor: "Graciliano Ramos", ano: 1938, editora: "Record", genero: "romance, ficcao", classificacao: "14+", sinopse: "A obra-prima de Graciliano Ramos narra a trajetória de uma família de retirantes e sua cachorra (Baleia) no sertão nordestino, lutando desesperadamente contra a seca, a fome e a exploração social em busca de melhores condições de vida." }
];
...
// ==========================================
// FUNÇÃO DE MIGRAÇÃO PARA LIVROS (NOVOS CAMPOS)
// ==========================================
...
db.on('ready', async () => {
    try {
        ...
        if (countLivros === 0) {
            ...
            console.warn(`📚 Já existem ${countLivros} livros. Executando migração...`);
            await migrarLivros();
        }
